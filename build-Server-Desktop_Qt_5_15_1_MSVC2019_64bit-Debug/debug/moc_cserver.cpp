...
#include <memory>
#include "../../Server/src/includes/cserver.h"
...
QT_MOC_LITERAL(3, 27, 17), // "deconnexionClient"
QT_MOC_LITERAL(4, 45, 12), // "sReceiveData"
QT_MOC_LITERAL(5, 58, 8), // "CClient*"
QT_MOC_LITERAL(6, 67, 6), // "sender"
QT_MOC_LITERAL(7, 74, 4) // "data"

    },
    "CServer\0nouvelleConnexion\0\0deconnexionClient\0"
    "sReceiveData\0CClient*\0sender\0data"
};
...
void CServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CServer *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->nouvelleConnexion(); break;
        case 1: _t->deconnexionClient(); break;
        case 2: _t->sReceiveData((*reinterpret_cast< CClient*(*)>(_a[1])),(*reinterpret_cast< QByteArray(*)>(_a[2]))); break;
        default: ;
        }
    }
}
