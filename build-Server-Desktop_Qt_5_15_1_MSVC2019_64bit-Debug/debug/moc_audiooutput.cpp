...
#include <memory>
#include "../../Server/src/includes/audiooutput.h"
...
void AudioOutput::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AudioOutput::error)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void AudioOutput::error(QString _t1)
{
